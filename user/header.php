...
<div id="header">
    ...
    <h2 style="color: white;position: absolute">
        <a href="dashboard.php" style="color:white; margin-left: 30px; margin-top: 40px">IMS USER</a>
    </h2>
</div>
...
<div id="sidebar">
    <ul>
        ...
        <li>
            <a href="view_bills.php"><i class="icon icon-home"></i><span>Sales Report & Returned Products</span></a>
        </li>
        <li>
            <a href="stock_master.php"><i class="icon icon-home"></i><span>Stock Master</span></a>
        </li>
        <li>
            <a href="return_product_list.php"><i class="icon icon-home"></i><span>Returned Product List</span></a>
        </li>
